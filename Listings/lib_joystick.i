...
void joystick_init(void) {
    ...
    ((LPC_PINCON_TypeDef *) ((0x40000000UL) + 0x2C000) )->PINSEL3 &= ~(3 << 26); // P1.29 for UP
    ((LPC_GPIO_TypeDef *) ((0x2009C000UL) + 0x00020) )->FIODIR &= ~(1 << 29); // Input

    ((LPC_PINCON_TypeDef *) ((0x40000000UL) + 0x2C000) )->PINSEL3 &= ~(3 << 26); // P1.26 for DOWN
    ((LPC_GPIO_TypeDef *) ((0x2009C000UL) + 0x00020) )->FIODIR &= ~(1 << 26); // Input

    ((LPC_PINCON_TypeDef *) ((0x40000000UL) + 0x2C000) )->PINSEL3 &= ~(3 << 26); // P1.27 for LEFT
    ((LPC_GPIO_TypeDef *) ((0x2009C000UL) + 0x00020) )->FIODIR &= ~(1 << 27); // Input

    ((LPC_PINCON_TypeDef *) ((0x40000000UL) + 0x2C000) )->PINSEL3 &= ~(3 << 26); // P1.28 for RIGHT
    ((LPC_GPIO_TypeDef *) ((0x2009C000UL) + 0x00020) )->FIODIR &= ~(1 << 28); // Input
}

// Read joystick UP state
int joystick_read_up(void) {
    return !(((LPC_GPIO_TypeDef *) ((0x2009C000UL) + 0x00020) )->FIOPIN & (1 << 29));
}

// Read joystick DOWN state
int joystick_read_down(void) {
    return !(((LPC_GPIO_TypeDef *) ((0x2009C000UL) + 0x00020) )->FIOPIN & (1 << 26));
}

// Read joystick LEFT state
int joystick_read_left(void) {
    return !(((LPC_GPIO_TypeDef *) ((0x2009C000UL) + 0x00020) )->FIOPIN & (1 << 27));
}

// Read joystick RIGHT state
int joystick_read_right(void) {
    return !(((LPC_GPIO_TypeDef *) ((0x2009C000UL) + 0x00020) )->FIOPIN & (1 << 28));
}
